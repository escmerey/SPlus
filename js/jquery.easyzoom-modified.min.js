...
(function($) {	  
	...
	function EasyZoom(target, settings){
		...
		this.reset = function() {		
			...
			return $this.fadeOut(0).detachEventListener();
		};
		...
		this.fadeOut = function() {
			$($this.settings.selector.window).fadeOut(0);	
			$($this.settings.selector.preview).fadeOut(0);
			return $this;
		};
		...
		this.showZoomWindow = function() {
            $($this.settings.selector.window).html(global.resource.image).fadeIn(0);	            
		};
		...
		this.showPreview = function(positionProperties) {				
			$($this.settings.selector.preview).css(positionProperties).fadeIn(0);				
		};
		...
		this.showNotification = function(notification) {
			$($this.settings.selector.window).fadeIn(0).text(notification);
			return $this;
		};
